...
// Search for win condition. if condition is met, drawWinLine() is called.
...
// Makes body elements temporarily unclickable.
function disableClick(){
  body.style.pointerEvents = "none";
  setTimeout(function() {body.style.pointerEvents = "auto";}, 1000);
}
// Play function plays the audio sound
function audio(audioURL){
  let audio = new Audio(audioURL);
  audio.play();
}

// This function draw the win line.
